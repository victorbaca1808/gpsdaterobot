...
public interface PruebaGCbRepository  extends JpaRepository<PruebaGCb, Long> {
	...
	@Query( value ="Select gps_Coordenadas as ubication, '' as Direccion from pruebagcb where numero_Telefono = :numTelefono order by fecha_Registro desc limit 3", nativeQuery = true)
